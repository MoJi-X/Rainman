    ...
    public Object intercept(Invocation invocation) throws Throwable {
            ...
            for (Field field : fields) {
                ...
                try {
                    if ("createBy".equals(field.getName())
                            || "createdByCode".equals(field.getName())
                            || "updateBy".equals(field.getName())
                            || "lastModifiedByCode".equals(field.getName())) {
                    ...
                    if ("createTime".equals(field.getName())
                            ...
                            || "lastModifiedDate".equals(field.getName())) {
                        field.setAccessible(true);
        ...
        if (SqlCommandType.UPDATE == sqlCommandType) {
            ...
            for (Field field : fields) {
                log.debug("------field.name------" + field.getName());
                try {
                    if ("updateBy".equals(field.getName()) || "lastModifiedByCode".equals(field.getName())) {
                        //获取登录用户信息
                        if (sysUser != null) {
                            // 登录账号
                            field.setAccessible(true);
                    ...
                    if ("updateTime".equals(field.getName()) || "lastModifiedDate".equals(field.getName())) {
                        field.setAccessible(true);
                        field.set(parameter, new Date());
                        field.setAccessible(false);
                    }
