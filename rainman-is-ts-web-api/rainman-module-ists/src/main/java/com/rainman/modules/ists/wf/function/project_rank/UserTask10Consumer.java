package com.rainman.modules.ists.wf.function.project_rank;
...
@Component("project_rank_user_task_10_consumer")
    ...
    public void accept(WfSubmitDto wfSubmitDto, Map<String, Object> variables) {
        ...
        for (Map<String, Object> map : mapList) {
            ...
            List<String> notUploadFileFlagNames = bdFileList.stream()
                    .filter(it -> StringUtils.isBlank(it.getBdFileId()))
        ...
        bdProjectService.lambdaUpdate()
                .set(BdProject::getDataStateCode, "in_progress")
