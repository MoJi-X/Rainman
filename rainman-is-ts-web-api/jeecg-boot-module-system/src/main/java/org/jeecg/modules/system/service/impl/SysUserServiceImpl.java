...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	@Override
	public String getUsername4aByUsername(String username) {
		return this.getBaseMapper().getUsername4aByUsername(username);
	}

	@Override
	public String getUsername4aByUserId(String userId) {
		return this.getBaseMapper().getUsername4aByUserId(userId);
	}
}
