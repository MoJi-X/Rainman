...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	public LoginUser getUserByRealname(String realname) {
		...
		SysUser sysUser = userMapper.getUserByRealname(realname);
	...
	public String getDepartNameByOrgCode(String orgCode) {
		SysDepart sysDepart = departMapper.queryCompByOrgCode(orgCode);
...
//			}
	 ...
	 */
	@Override
	public Set<String> queryUserRoleName(String username) {
