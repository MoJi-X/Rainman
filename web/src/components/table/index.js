...
export default {
      ...
      if (result instanceof Promise) {
        result.then(r => {
          this.localPagination = Object.assign({}, this.localPagination, {
            current: r.pageNo||r.current,  // 返回结果中的当前分页数
          ...
          (!this.showPagination || !(r.totalCount||r.total) && this.showPagination === 'auto') && (this.localPagination = false)
          //update--end--autor:wangshuai-----date:20200724------for：判断showPagination是否为false-----
          this.localDataSource = r.data||r.records; // 返回结果中的数组数据
  ...
  render(h) {
    ...
    let props = {},
      ...
      console.log("表格带的属性",Object.keys(T.props))
