package com.rainman.modules.ists.wf.function.network_access;
...
public class UserTask20Consumer implements BiConsumer<WfSubmitDto, Map<String, Object>>, BeanPostProcessor {
    ...
    private List<String> fileFlagCodeList;

    public UserTask20Consumer(List<String> fileFlagCodeList) {
        this.fileFlagCodeList = fileFlagCodeList;
    }
    ...
    public void accept(WfSubmitDto wfSubmitDto, Map<String, Object> variables) {
        ...
        if (org.apache.commons.lang3.StringUtils.isEmpty(wfSubmitDto.getWfNextNodeCandidateUsers())) {
            ...
            if(!StringUtils.equals(wfNodeCode,"70")){
                throw new Exception("流程下一个节点处理人编号集合不能为空值");
            }
        }

        if (CollectionUtils.isNotEmpty(fileFlagCodeList)) {
