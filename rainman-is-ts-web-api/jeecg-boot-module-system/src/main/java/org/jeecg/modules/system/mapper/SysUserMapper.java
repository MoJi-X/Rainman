...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	public SysUser getUserByRealname(@Param("realname") String realname);
	 ...
	 * @return
	 */
	String getUsername4aByUsername(String username);
	 ...
	 * @return
	 */
	String getUsername4aByUserId(String userId);
}
